"""Scaled dot-product attention for Amosclaud intelligence experiments.

This module is intentionally separate from the production API router. It can be
used by a configured PyTorch model service without forcing the web server to
