...
from amoscloud_ai.api.routes.runtime_telemetry import router as runtime_telemetry_router
...
router.include_router(runtime_telemetry_router, prefix="/cooperation/runtime")
