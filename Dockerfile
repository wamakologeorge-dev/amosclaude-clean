...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    AMOSCLAUD_RUNNER_TIMEOUT_SECONDS=1800 \
    AMOSCLAUD_RUNNER_MEMORY=2g
...
CMD ["sh", "-c", "exec /app/docker/otel-exec.sh uvicorn amoscloud_ai.connected_app:app --host 0.0.0.0 --port ${PORT:-8000}"]
