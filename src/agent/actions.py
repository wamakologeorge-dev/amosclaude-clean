...
def _resolve_workspace(workspace: str) -> Path:
    ...
    application source lives under ``/app``. Calls may therefore carry an
    absolute repository path generated by Amosclaud itself. The path is
    canonicalized and accepted only when it remains under one of those trusted
    roots, including after symlink resolution.
    """
    ...
    anchored = workspace_path if workspace_path.is_absolute() else (base / workspace_path)
